...
(function() {
  ...
  SQGAMESDK.prototype.login = function(cb) {
    SDK.login({}, function(data) {
      if (data.error) console.log(data.error);
        ...
        wx.request({
          url: 'https://apigameh5.37.com/enter/awyxcx/17?a=quickAppEnter',
          data: data,
          success: function(res) {
            ...
            //MP统计
            wx.request({
              url: 'https://apigameh5.37.com/index.php?c=api&a=default&cc=Api&ca=stat_share&appid=awyxcx&game_id=17',
              data: {
  ...
  SQGAMESDK.prototype._levellog = function(data) {
    ...
    data.game_id = 17;
    wx.request({
      url: 'https://apigameh5.37.com/index.php?c=api&a=default&cc=Api&ca=levelReport&appid=awyxcx&game_id=17',
      data: data,
      success: function(json) {},
      fail: function(status) {}
    });
