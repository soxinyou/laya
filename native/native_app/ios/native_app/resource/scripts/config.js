...
//        this.bridge.call("loading:", 0);
//        var _t = this;
//        console.log("show loadingView:===");
//        var n = this.n = new ConchNode();
//                    console.log("show loadingView:iiii");
//        var img = document.createElement("img");

//        img.onload = function () {
//                   _t.bg = _t.createNode(img, 0, 0, img.width, img.height);
//                   _t.bgW=img.width;
//                   _t.bgH=img.height;
//                   n.addChildAt(_t.bg,0);
//                   console.log("show login——bg",img.width,img.height);
//                   _t.addChild(n);
//                   _t.onresize();
//                   document.addEventListener("resize", _t.onresize.bind(_t));
//        };
//         console.log("show loadingView:url--"+n.Protocol,n.Path);
//        var urls =ConchNode.Protocol + ConchNode.Path + "login_bg.jpg";
//                   img.src =urls;
//                   console.log("show loadingView:url--"+urls);
    }
...
//                this.bridge.call("setTips:", value);
   ...
   loadingView.prototype.exitGame = function () {
        this.bridge.call("exitApplication");
   };
    return loadingView;
}());
